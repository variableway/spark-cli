...
import (
	...
	"spark/internal/witr/output"
	"spark/internal/witr/pipeline"
	procpkg "spark/internal/witr/proc"
	"spark/internal/witr/source"
	"spark/internal/witr/target"
	"spark/internal/witr/tui"
...
func init() {
	...
	rootCmd.Flags().StringSlice("pid", nil, "pid(s) to look up (repeatable)")
